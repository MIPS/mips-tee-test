...
const TEEC_UUID multi_instance_memref_ta_uuid = TA_MULTI_INSTANCE_MEMREF_UUID;
const TEEC_UUID bad_manifest_ta_uuid = TA_BAD_MANIFEST_UUID;
...
const TEEC_UUID client_ta_uuid = TA_CLIENT_TA_UUID;
const TEEC_UUID siss_ta_uuid = TA_SISS_TA_UUID;
const TEEC_UUID core_test_ta_uuid = TA_CORE_TEST_UUID;
#ifdef WITH_GP_TESTS
