...
/* Not in GP Client API */
#define TEEC_MEM_INOUT   (TEEC_MEM_INPUT | TEEC_MEM_OUTPUT)

/* TEE specific defines - this has to be in sync with defines in file
 * tee_api_defines.h on TEE side
 */
...
/* Property Sets Pseudo-Handles (without cast to propset handle type) */
...
/* Algorithm Identifiers from v1.1 deprecated in v1.1.2 */
